...
# cms analytics LinearRegression codegen sklearn linearmodel --port=8002

# cms analytics LinearRegression server start detached --cloud=local
# sleep 3
# cms analytics LinearRegression
# cms analytics LinearRegression fit --X="[[1,2]]" --y="[[3,4]]"
# cms analytics LinearRegression predict --X="[[1,2]]"
# cms analytics LinearRegression file upload --filename=tests/test_uploaded_files/user_input_data.csv
# cms analytics LinearRegression predict --X=user_input_data
# cms analytics LinearRegression file list
# cms analytics LinearRegression file read --filename=user_input_data
# cms analytics LinearRegression
...
#   eval ("import build.LinearRegression")
